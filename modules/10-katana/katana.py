...
class KatanaModule(BaseModule):
    ...
    def __init__(self, args):
        ...
        self.output_file: str = f"{self.output}/katana.jsonl"
        self.output_urls_file: str = f"{self.output}/katana-urls.txt"
        self.output_filtered_file: str = f"{self.output}/katana-filtered.txt"
